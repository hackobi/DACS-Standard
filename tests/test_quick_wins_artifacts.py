...
class QuickWinsArtifactTests(unittest.TestCase):
    ...
    def test_quick_wins_document_reports_all_ten_complete(self):
        quick_wins = (ROOT / "QUICK_WINS.md").read_text(encoding="utf-8")
        self.assertIn("10 of 10", quick_wins)
        self.assertNotIn("[ ]", quick_wins)
